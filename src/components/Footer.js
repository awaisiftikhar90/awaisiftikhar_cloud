            ...
            <div className="col-md">
              <div className="ftco-footer-widget mb-4">
                ...
                <ul className="list-unstyled">
                  ...
                  <li><a href="#"><span className="icon-long-arrow-right mr-2"></span>Cloud Services</a></li>
              ...
              <div className="ftco-footer-widget mb-4">
                ...
                <div className="block-23 mb-3">
                  <ul>
                    ...
                    <li><a href="#"><span className="icon icon-phone"></span><span className="text">+1-202-407-6174</span></a></li>
